...
class Strings {
  ...
  static const youHaveNoPosts =
      'You have not made a post yet. Press either h]thee video-upload or the photo-upload buttons to the top of the screen in order to upload your first post!';
  static const noPostsAvailable =
      "Nobody seems to have made any posts yet. Why don't you take the first step upload your first post?!";
  static const enterYourSearchTerm =
      'Enter your search term in order go get started. You can search in th description of all posts available in the system';
  ...
  static const noCommentsYet =
      'Nobody has commented on this post yet. You can change that though, an bethe first person who comments!';
